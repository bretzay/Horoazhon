...
- Detect V1__create_initial_schema.sql and V2__create_test_data.sql migrations
- Execute them on the remote database
- Create all tables, constraints, indexes, and seed data
